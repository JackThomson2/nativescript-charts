...
import {
	...
	ILineSeries,
	LegendForm
} from 'nativescript-charts/line-chart';
...
export function pageLoaded(args: observable.EventData) {
	...
	chartData.push(addData({ x: -5, y: 20 }, { x: -25, y: 20 }));
	chartData.push(addData({ x: -25, y: 20 }, { x: -5, y: 40 }));
	chartData.push(addData({ x: -5, y: 40 }, { x: -20, y: 40 }));
	chartData.push(addData({ x: -20, y: 40 }, { x: -5, y: 60 }));
	chartData.push(addData({ x: -5, y: 60 }, { x: -15, y: 60 }));
	chartData.push(addData({ x: -15, y: 60 }, { x: -5, y: 80 }));
	chartData.push(addData({ x: -5, y: 80 }, { x: -10, y: 80 }));
	chartData.push(addData({ x: -10, y: 80 }, { x: 0, y: 100 }));
	chartData.push(addData({ x: 0, y: 100 }, { x: 10, y: 80 }));
	chartData.push(addData({ x: 10, y: 80 }, { x: 5, y: 80 }));
	chartData.push(addData({ x: 5, y: 80 }, { x: 15, y: 60 }));
	chartData.push(addData({ x: 15, y: 60 }, { x: 5, y: 60 }));
	chartData.push(addData({ x: 5, y: 60 }, { x: 20, y: 40 }));
	chartData.push(addData({ x: 20, y: 40 }, { x: 5, y: 40 }));
	chartData.push(addData({ x: 5, y: 40 }, { x: 25, y: 20 }));
	chartData.push(addData({ x: 25, y: 20 }, { x: 5, y: 20 }));
	chartData.push(addData({ x: 5, y: 20 }, { x: 5, y: 0 }));
	chartData.push(addData({ x: 5, y: 0 }, { x: -5, y: 0 }));
	//console.log(5)
